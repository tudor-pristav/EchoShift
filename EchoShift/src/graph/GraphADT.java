...
public interface GraphADT {
  ...
  public void insertEdge(GraphNode nodeu, GraphNode nodev, char type, String label) throws GraphException;
  
  /* Adds to the graph an edge connecting nodes u and v. The type and label for this new edge 
     are as indicated by the last parameters. This method throws a GraphException if either node 
     does not exist or if there is already an edge connecting the given vertices. */
  public void insertEdge(GraphNode nodeu, GraphNode nodev, char type) throws GraphException;
