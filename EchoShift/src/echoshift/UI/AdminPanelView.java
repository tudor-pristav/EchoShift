...
public class AdminPanelView{
    ...
    public AdminPanelView() {
        this.loginButton = createButton("Manage Accounts", 220, 42);
        this.instructionsButton = createButton("Create Account", 220, 42);
        this.highScoresButton = createButton("Reset High Scores", 220, 42);
        this.settingsButton = createButton("Settings", 220, 42);
        this.exitButton = createButton("Exit", 200, 42);
        this.logoutButton = createButton("Logout", 200, 42);
    }
    ...
    public Parent createMainMenu() {
        ...
        Label title = createLabel("Admin Panel", 50);
